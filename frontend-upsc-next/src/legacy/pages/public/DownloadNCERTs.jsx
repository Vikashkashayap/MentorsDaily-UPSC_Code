...
export default function DownloadNCERTs() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Download NCERTs</h1>
          <p className="text-gray-600">Exciting new resources are on their way!</p>
        </div>
        
        <div className="bg-indigo-50 rounded-lg p-4 mb-6">
          <h2 className="text-xl font-semibold text-indigo-800 mb-2">Coming Soon</h2>
          <p className="text-indigo-600">We're working hard to bring you downloadable NCERT materials. Stay tuned!</p>
        </div>
