          ...
          <div className="flex items-center gap-3 md:gap-4 flex-1">
            ...
            <div className="text-left">
              <div className="flex items-center gap-2 mb-1">
                <div className="text-blue-200 text-xs tracking-widest font-bold uppercase flex items-center gap-1">
                  <span className="w-2 h-2 bg-yellow-300 rounded-full animate-pulse shrink-0" aria-hidden="true" />
                  LIMITED TIME
                </div>
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                <div className="text-yellow-100 font-bold flex items-center gap-1">
                  <span className="w-2 h-2 bg-yellow-300 rounded-full animate-pulse shrink-0" aria-hidden="true" />
