...
export function getPaymentCourseId(course) {
  ...
  const slug = String(course.slug || "")
    ...
    .toLowerCase();
  const bySlug = {
    "integrated-mentorship-2027": process.env.NEXT_PUBLIC_IMP_2027_COURSE_ID,
    "integrated-mentorship-2028": process.env.NEXT_PUBLIC_IMP_2028_COURSE_ID,
    "integrated-mentorship-2029": process.env.NEXT_PUBLIC_IMP_2029_COURSE_ID,
    "integrated-mentorship-2030": process.env.NEXT_PUBLIC_IMP_2030_COURSE_ID,
    "uppcs-2026-complete": process.env.NEXT_PUBLIC_UPPCS_2026_COMPLETE_COURSE_ID,
    "uppcs-2026-prelims-booster": process.env.NEXT_PUBLIC_UPPCS_2026_PRELIMS_COURSE_ID,
    "uppcs-2026-upsc-combo": process.env.NEXT_PUBLIC_UPPCS_2026_COMBO_COURSE_ID,
    "uppcs-2026-mains-booster": process.env.NEXT_PUBLIC_UPPCS_2026_MAINS_COURSE_ID,
    "uppcs-2027-daily": process.env.NEXT_PUBLIC_UPPCS_2027_DAILY_COURSE_ID,
    "uppcs-2027-bns-prelims": process.env.NEXT_PUBLIC_UPPCS_2027_BNS_PRELIMS_COURSE_ID,
    "uppcs-2027-upsc-combo": process.env.NEXT_PUBLIC_UPPCS_2027_COMBO_COURSE_ID,
    "uppcs-2027-mains-booster": process.env.NEXT_PUBLIC_UPPCS_2027_MAINS_COURSE_ID,
    "mppsc-2027-daily": process.env.NEXT_PUBLIC_MPPSC_2027_DAILY_COURSE_ID,
  };
  const fromSlug = bySlug[slug];
  if (typeof fromSlug === "string" && fromSlug.trim()) return fromSlug.trim();
  if (
    /^mppsc-2027-/.test(slug) &&
    typeof process.env.NEXT_PUBLIC_MPPSC_PAYMENT_COURSE_ID === "string" &&
    process.env.NEXT_PUBLIC_MPPSC_PAYMENT_COURSE_ID.trim()
  ) {
    return process.env.NEXT_PUBLIC_MPPSC_PAYMENT_COURSE_ID.trim();
  }
  if (
    /^uppcs-20(26|27)-/.test(slug) &&
    typeof process.env.NEXT_PUBLIC_UPPCS_PAYMENT_COURSE_ID === "string" &&
    process.env.NEXT_PUBLIC_UPPCS_PAYMENT_COURSE_ID.trim()
  ) {
    return process.env.NEXT_PUBLIC_UPPCS_PAYMENT_COURSE_ID.trim();
  }
  const fallback = process.env.NEXT_PUBLIC_PAYMENT_FALLBACK_COURSE_ID;
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const options = {
        ...
        name: process.env.NEXT_PUBLIC_RAZORPAY_PAYMENT_SCREEN_NAME,
