  ...
  return (
    <div className={`min-h-screen flex items-center justify-center ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-md w-full mx-auto text-center px-4">
        {/* 404 Illustration */}
        <div className="mb-8">
          <div className={`text-9xl font-bold ${isDark ? 'text-gray-700' : 'text-gray-300'} mb-4`}>
            404
          </div>
          <div className="relative">
            <svg 
              className={`w-32 h-32 mx-auto ${isDark ? 'text-gray-600' : 'text-gray-400'}`} 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
              <path 
                ...
                strokeWidth="1" 
                d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.291-1.007-5.691-2.709M15 11V9a6 6 0 10-12 0v2m5.121-8.121A2.5 2.5 0 1115.5 6.5v1m0 0V9"
              />
            </svg>
          </div>
        </div>
