  ...
  return {
    ...
    testimonialsSection: {
      ...
      items: [
        ...
        { stage: "Working Professional", quote: "Before enroll in mentorsdaily I thought i was in right direction and path, but they made me to understand that i was in right path and in wrong direction. It’s the place where aspirants are created by them rather than making..", name: "Shiva Prasad", loc: "Banglore", initial: "SY", avBg: "var(--imp-green)" },
      ],
    },
    faqSection: {
      tag: "FAQs",
