/**
 * Default long-form landing copy for Integrated Mentorship 2030.
 * Admin overrides merge shallow-deep via course.detailPage (Mongo Mixed).
 */

export const IMP_2030_SLUG = "integrated-mentorship-2030";
...
export function getDefaultImp2030DetailPage() {
  return {
    seo: {
      title: "IMP 2030 – 66-Month Integrated UPSC Mentorship Program | MentorsDaily",
      description:
        "Join MentorsDaily IMP 2030 — a 66-month personalized UPSC CSE 2030 journey with 100% fee refund after clearing Prelims, 1:1 mentoring, free hostel, meals & stationery for Mains, and next-attempt support.",
    },
    announcement: {
      strong: "🎉 Early Bird:",
    ...
    hero: {
      ...
      cardTitle: "Integrated Mentorship Program (IMP) 2030",
    ...
    trustBar: [
      ...
      { icon: "CalendarCheck", num: "66", lbl: "Months of Guidance" },
      { icon: "MapPin", num: "Noida", lbl: "Office + Hostel" },
    ],
    pricingSection: {
      tag: "Daily Mentorship Plan",
      title: "One Plan.\nComplete Support.",
      sub: "Daily 1:1 mentorship covering the full 66-Month IMP 2030 journey — structured targets, evaluations, tests and complete program support.",
      toggleHint: "",
      weekly: {
    ...
    uspSection: {
      ...
      cards: [
        ...
        },
        {
          ...
          body: "",
          bodyHtml:
            "If you complete the full IMP 2030 program and don't qualify in your first attempt, we continue your mentorship for the next attempt at <strong>zero additional fee</strong>. No re-enrollment, no extra charges — we stay with you until you clear it.",
          stepsMode: "stack",
    ...
    featuresSection: {
      tag: "WHAT YOU GET",
      title: "Everything You Need to Clear UPSC 2030",
      sub: "IMP 2030 is built so every day of your preparation has a clear purpose, a defined outcome, and a mentor watching your back.",
      items: [
        ...
        { theme: "sky", icon: "FlaskConical", title: "10,000+ Questions - Module Tests with Pass Standards", body: "A bank of 10,000+ Prelims questions targeting 100 full CSE 2030 papers. Every module has a 50% minimum pass mark — with anti-cheat screen-switch detection built in." },
    ...
    timelineSection: {
      tag: "YOUR 66-MONTH JOURNEY · APR 2026 · MAY 2031",
      ...
      phases: [
        ...
        },
        {
          ...
          label: "Final Result",
          detail:
            "UPSC Final Result announced · 66 months of structured preparation complete · Your IAS/IPS journey begins",
          duration: "MONTH 66",
          durationTone: "lavender",
        },
      ],
      note: "Fee refund triggers the moment you clear Prelims. Hostel + meals + stationery activate from May 2030. If you don't clear in 2030, your next attempt is fully covered at zero extra cost — your mentor stays with you throughout.",
    },
    includedSection: {
      tag: "FULL CURRICULUM",
      title: "What's Included at Every Stage",
      sub: "IMP 2030 covers you from the first study session to the final interview panel — here's exactly what you get at each stage.",
      tabs: [
          ...
          items: [
            {
              ...
              body: "Complete one full reading of the entire UPSC syllabus: all NCERTs plus standard references like Laxmikanth, Nitin Singhania, and more. Done by December 2028 — 9 months in.",
            },
            {
              icon: "NotebookPen",
            ...
            },
            {
              ...
              body: "Mains-style answer writing begins from Month 1 — not after Prelims. By December 2028, you'll be ready to secure good marks even if Mains were held early.",
            },
            {
              icon: "FlaskConical",
    ...
    faqSection: {
      ...
      items: [
        ...
        { q: "What happens if I don't qualify in my 2030 attempt?", a: "If you complete the full IMP 2030 program and don't qualify in your 2030 attempt, we continue your mentorship for the 2031 attempt at zero additional fee — no re-enrollment and no extra program charges. Your mentor stays with you; syllabus and materials update so you're always aligned to the current exam cycle." },
        ...
        { q: "How do I enroll in IMP 2030?", a: 'You can enroll directly by clicking "Enroll Now" on this page, calling us at +91 87662 33193, or messaging on WhatsApp. Once enrolled, you\'ll receive onboarding details and be matched with a mentor within 48 hours. EMI options are available — contact us for details.' },
      ],
    },
    bottomCta: {
      title: "Your UPSC 2030 Journey Starts Here",
      sub: "66 months from now, you could be clearing Prelims and claiming your full fee back. Or you could still be figuring out where to start. The decision is now.",
      primary: "Enroll in IMP 2030",
    ...
    footer: {
      ...
      quickLinks: [
        ...
        { label: "IMP 2030", href: "/integrated-mentorship-2030" },
