/**
 * Default long-form landing copy for Integrated Mentorship 2029 (48-month program).
 * Admin overrides merge via course.detailPage — same shape as IMP 2028.
 */
...
export const IMP_2029_SLUG = "integrated-mentorship-2029";

export function getDefaultImp2029DetailPage() {
  return {
    seo: {
      title: "IMP 2029 – 48-Month Integrated UPSC Mentorship Program | MentorsDaily",
      description:
        "Join MentorsDaily IMP 2029 — India's most comprehensive 48-month UPSC mentorship with 1:1 personalized mentoring, Student Dashboard, AI Mentor, unlimited questions & 3 unmatched guarantees.",
    },
    announcement: {
      strong: "🎉 3 Guarantees, 0 Risk:",
      text: "100% Fee Refund · Free Hostel at Mains · Next Attempt Free — Only 10 seats per mentor. Enrolling now.",
      ctaText: "Reserve Your Seat →",
      ctaHref: "#enroll",
    },
    hero: {
      badge: "India's Most Exclusive 48-Month UPSC Mentorship Program 2029",
      badgeIcon: "Award",
      titleLines: [
        { text: "48 Months.One Mentor." },
        // { text: "10 Students." },
        { fragment: true, accentText: "3 Guarantees", after: " & an AI-Powered Dashboard." },
      ],
      subHtml:
        "IMP 2029 is MentorsDaily’s most comprehensive UPSC mentorship—a dedicated 1:1 mentor for 48 months (max 10 students per mentor), a personalised AI-powered Student Dashboard with 20,000+ practice questions, and 3 unmatched guarantees for complete peace of mind. Designed to help you reach your IAS goal.",

      perks: [
        "1:1 Dedicated Mentor",
        "Max 10 Students Per Mentor",
        "AI Mentor — 24/7 Doubt Clearing",
      ...
      cardBannerTitle: "INTEGRATED MENTORSHIP PROGRAM 2029",
      cardListingTitle: "Integrated Mentorship Program (IMP) 2029",
      cardMetaPills: [
        { icon: "Clock", label: "48 Months" },
        { icon: "Sun", label: "Hybrid" },
        { icon: "Globe", label: "English & Hindi" },
      ],
      cardTitle: "Integrated Mentorship Program (IMP) 2029",
      cardSubtitle: "48 Months · UPSC CSE Prelims + Mains + Interview",
      cardFeatures: [
    ...
    trustBar: [
      ...
      { icon: "UserRound", num: "Max 10", lbl: "Students Per Mentor" },
      { icon: "CalendarCheck", num: "48", lbl: "Months of Guidance" },
      { icon: "CircleHelp", num: "Unlimited", lbl: "Practice Questions" },
    ],
    pricingSection: {
      tag: "Choose Your Plan",
      title: "Two Plans. One 48-Month Journey.",
      sub: "Both plans cover the complete IMP 2029 program and all 3 guarantees. Choose the mentorship intensity that fits your lifestyle.",
      daily: {
        name: "Daily Plan",
        ...
        price: 120000,
        oldPrice: 240000,
        saveLabel: "Save ₹1,20,000 — 50% OFF",
        durationLine: "48-Month Program · Batch Starts April 2026",
        features: [
      ...
      weekly: {
        ...
        price: 90000,
        oldPrice: 135000,
        saveLabel: "Save ₹45,000 — 33.33% OFF",
        durationLine: "48-Month Program · Batch Starts April 2026",
        features: [
    ...
    uspSection: {
      ...
      sub: "IMP 2029 is backed by three guarantees no other UPSC program offers — because we're as committed to your success as you are.",
      cards: [
        {
          variant: "green",
          icon: "IndianRupee",
          title: "100% Fee Refund",
          body: "Clear your UPSC Prelims after completing IMP 2029, and we refund your entire program fee — every rupee, no questions asked.",
        ...
        },
        {
          ...
          body: "If you complete IMP 2029 but don't clear in the first attempt, your next full attempt is on us — at zero additional fee.",
          steps: ["Complete next attempt at ₹0"],
        },
      ],
      competitorHtml:
        "<strong>No other UPSC program in India offers all three guarantees together.</strong> IMP 2029 is built on a single belief: if you put in the work, your success should be guaranteed.",
    },
    featuresSection: {
      tag: "What Makes IMP 2029 Different",
      title: "Every Feature Designed\nfor UPSC 2029 Success",
      sub: "A 48-month program built on mentorship, data-driven tracking, and deep personalisation — not one-size-fits-all coaching.",
      items: [
        { theme: "navy", icon: "UserRound", title: "1:1 Dedicated Mentor", body: "Your mentor knows your strengths, weak areas, and personal study pace. With max 10 students per mentor, you get undivided attention throughout your 48-month journey." },
        ...
        { theme: "purple", icon: "Brain", title: "Personality Development + Expert Psychological Support", body: "Structured personality development sessions and dedicated mental health check-ins to keep you motivated, focused, and mentally resilient through the 48-month journey." },
      ],
    },
    dashboardSection: {
    ...
    timelineSection: {
      ...
      phases: [
        { numLabel: "1", color: "#E86B2A", sub: "APR–JUN 2026", label: "Orientation & Foundation" },
        { numLabel: "2", color: "#24527A", sub: "JUL–SEP 2026", label: "NCERTs & Core Concepts" },
        { numLabel: "3", color: "#5B8DB8", sub: "OCT 2026–SEP 2027", label: "GS Papers 1–4 + Workshops" },
        { numLabel: "4", color: "#24527A", sub: "OCT 2027–JUN 2028", label: "Integrated Revision + Current Affairs" },
        { numLabel: "5", color: "#5B8DB8", sub: "JUL–OCT 2028", label: "Full Mock Test Series" },
        { numLabel: "6", color: "#E86B2A", sub: "NOV 2028–APR 2029", label: "Prelims Final Sprint" },
        { numLabel: "🎯", color: "#2D7D4E", sub: "MAY 2029", label: "PRELIMS EXAM", highlight: true },
        { numLabel: "7", color: "#24527A", sub: "JUN–AUG 2029", label: "Mains Answer Writing Intensive" },
        { numLabel: "8", color: "#5B8DB8", sub: "SEP 2029–JAN 2030", label: "MAINS + INTERVIEW" },
        { numLabel: "🏆", color: "#F59E0B", sub: "APRIL 2030", label: "FINAL RESULT" },
      ],
      note:
        "GS Paper Deep Dive & Answer Writing Workshops:\n• GS Paper 1: Oct–Dec 2026 → 15-Day Workshop: January 2027\n• GS Paper 2: Jan–Mar 2027 → 15-Day Workshop: April 2027\n• GS Paper 3: Apr–Jun 2027 → 15-Day Workshop: July 2027\n• GS Paper 4: Jul–Sep 2027 → 15-Day Workshop: October 2027\n\nAll phases are covered in both Daily and Weekly plans. Your mentor personalises the pace and depth at every stage based on your actual progress.",
    },
    includedSection: {
      tag: "What's Included",
      title: "Everything You Get in IMP 2029",
      ...
      tabs: [
        {
          ...
          label: "Mentorship",
          items: [
            { icon: "UserRound", title: "1:1 Dedicated Mentor", body: "Your personalized mentor understands your strengths, weak areas, and study pace. With a maximum of 10 students per mentor, you receive undivided attention throughout your 48-month journey.." },
        ...
        },
        {
          ...
          items: [
            ...
            { icon: "Map", title: "48-Month Module Roadmap", body: "A structured phase-by-phase roadmap covering all 10 phases — from Foundation to Mains & Interview. Always know exactly where you are and what's next." },
          ],
        },
        {
          id: "tests",
        ...
        },
        {
          ...
          label: "Guarantees",
          items: [
            { icon: "IndianRupee", title: "100% Fee Refund Guarantee", body: "Clear UPSC Prelims after completing IMP 2029 and receive a full refund of your entire program fee. No conditions, no deductions — your success is our accountability.", border: "green" },
            ...
            { icon: "RefreshCw", title: "Next Attempt Free Guarantee", body: "If you complete IMP 2029 sincerely but don't clear in the first attempt, your next complete attempt with a dedicated mentor is provided at absolutely zero additional fee.", border: "purple" },
    ...
    testimonialsSection: {
      ...
      items: [
        { stage: "IMP 2029 Student", quote: "Having a mentor who reviews my progress every day changed everything. I stopped wasting time on irrelevant topics and started focusing on what actually matters for UPSC. The Student Dashboard is genuinely a game-changer.", name: "Arjun Mehta", loc: "Lucknow, UP · Prelims 2026 Aspirant", initial: "A", avBg: "#1A3C6E" },
        { stage: "IMP 2029 Student", quote: "The MAP Report every 15 days gives me a crystal-clear picture of where I stand and exactly what to fix. My mentor doesn't just track me — he genuinely understands my preparation and guides me accordingly.", name: "Priya Nair", loc: "Kochi, Kerala · Working Professional", initial: "P", avBg: "#5B8DB8" },
        { stage: "IMP 2029 Student", quote: "The 3 guarantees removed all my hesitation. And now 8 months in, I can say MentorsDaily delivers on every promise. The fault analysis showed me patterns in my mistakes I never noticed myself.", name: "Rohan Sharma", loc: "Jaipur, Rajasthan · Fresh Graduate", initial: "R", avBg: "#2D7D4E" },
      ],
    },
    faqSection: {
      tag: "FAQs",
      title: "Questions About IMP 2029?",
      sub: "Everything you need to know before enrolling. If your question isn't here, call or WhatsApp us anytime.",
      items: [
        { q: "What is IMP 2029?", a: "IMP 2029 (Integrated Mentorship Program 2029) is MentorsDaily's flagship 48-month UPSC mentorship designed for aspirants targeting UPSC CSE 2029. It provides a dedicated 1:1 mentor (max 10 students per mentor), a personalised Student Dashboard, 20,000+ practice questions, UPSC-style mock tests, and three industry-first guarantees — all in one program." },
        { q: "When does the program start and how long is it?", a: "IMP 2029 begins in April 2026 and runs for 48 months, ending in April 2030. The roadmap covers every stage from foundation through Prelims (May 2029), Mains & Interview, to final result." },
        { q: "What is the difference between the Daily and Weekly plans?", a: "Both plans cover the complete 48-month IMP 2029 journey and include all 3 guarantees. The Daily Plan (₹1,19,999) includes daily 1:1 mentor sessions, 6-hour doubt clearing, MAP Reports every 15 days, and full Practice Hub access. The Weekly Plan (₹79,999) includes weekly 1:1 sessions, 48-hour doubt clearing, bi-monthly MAP Reports, and limited Practice Hub access. All other features — mock tests, answer writing, books, and guarantees — are identical." },
        { q: "How many students does each mentor handle?", a: "Each mentor handles a maximum of 10 students in IMP 2029. This strict limit ensures every student receives genuinely personalised attention — your mentor knows your preparation inside-out, not just your name." },
        { q: "Are there any lectures or classes in IMP 2029?", a: "No. IMP 2029 is a pure mentorship program — there are no lectures, recorded or live, of any kind throughout the course. The program is built entirely on 1:1 personalised mentoring, self-study guided by your mentor, and practice through the Student Dashboard." },
        { q: "What is the Student Dashboard and how does it help?", a: "The Student Dashboard is a personalised digital platform exclusive to IMP 2029 students. It includes 8 features: Module Roadmap, Weekly Target System, Syllabus Tracker, UPSC-Style Mock Tests, Fault Analysis, Practice Hub (20,000+ questions), Live Progress Dashboard, and AI Mentor for 24×7 smart guidance." },
        { q: "What are the UPSC-Style Mock Tests? Are they NTA-based?", a: "No — the mock tests in IMP 2029 are UPSC-pattern tests, not NTA-based. They mirror the actual UPSC CSE Prelims question style, difficulty, and pattern. Each test comes with detailed solutions, topic-wise analysis, rank comparisons, and Fault Analysis." },
        ...
        { q: "What does the 100% Fee Refund guarantee mean exactly?", a: "If you complete the IMP 2029 program and clear UPSC Prelims, MentorsDaily will refund your entire program fee — 100%, with no deductions. Terms and conditions apply and are shared in full at enrolment." },
        { q: "What happens if I don't clear in my first attempt?", a: "If you complete IMP 2029 sincerely but don't clear in the first attempt, your next complete attempt — including a dedicated mentor for the full preparation cycle — is provided at zero additional fee. This is our Third Guarantee, and it applies to both Daily and Weekly plan students." },
    ...
    bottomCta: {
      title: "Your UPSC 2029 Journey\nStarts in April 2026.",
      sub: "Only 10 seats per mentor. Once filled, they're gone. Lock in your seat today and begin the most structured UPSC preparation of your life.",
