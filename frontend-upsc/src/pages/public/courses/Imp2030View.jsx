...
function renderComparisonValueCell(value) {
  ...
  return (
    <span className="inline-flex min-w-[44px] justify-center px-2 py-1 rounded-md bg-white text-[#042F2E] text-[0.9rem] font-extrabold shadow-sm">
      {String(value)}
    </span>
  );
}

export default function Imp2030View({
  d,
  sellingPrice,
  basePrice,
  discountPercentage,
  ...
  const dashboardCards = [
    {
      ...
      body: "Visual journey of your entire 66-month syllabus broken into structured, week-by-week modules.",
      icon: "Map",
      accent: "border-[#115E59]",
      iconShell: "bg-[#E8F1FF] text-[#115E59]",
    },
    {
      ...
      iconShell: "bg-[#CCFBF1] text-[#0D9488]",
    },
    {
    ...
    },
    {
      ...
      iconShell: "bg-[#D5E8F0] text-[#115E59]",
  ...
  return (
    <div className="imp2030-root bg-white overflow-x-hidden pb-24 md:pb-0">
      {/* Announcement */}
      <div className="bg-[#042F2E] text-[#D5E8F0] text-center py-2 px-6 text-sm font-medium">
        <strong className="text-[#0D9488]">{d.announcement.strong}</strong> {d.announcement.text}{" "}
        <button
          type="button"
          className="text-[#0D9488] font-bold ml-3 bg-transparent border-0 cursor-pointer p-0 font-inherit underline-offset-2 hover:underline"
      ...
      <section className="relative bg-gradient-to-br from-[#042F2E] via-[#115E59] to-[#134E4A] pt-16 pb-14 overflow-hidden" id="top">
        <div className="pointer-events-none absolute -top-[120px] -right-[120px] w-[500px] h-[500px] rounded-full bg-[radial-gradient(circle,rgba(13,148,136,0.12)_0%,transparent_70%)]" />
        <div className="max-w-[1180px] mx-auto px-6 grid lg:grid-cols-[1fr_420px] gap-14 lg:gap-16 items-center">
          <div>
            <div className="imp-fade-up inline-flex items-center gap-1.5 bg-[rgba(13,148,136,0.18)] border border-[rgba(13,148,136,0.4)] text-[#0D9488] text-[0.82rem] font-bold px-3.5 py-1.5 rounded-full mb-5">
            ...
            <h1 className="imp-fade-up delay-1 font-['Poppins'] font-black text-[clamp(1.9rem,4vw,2.9rem)] text-white leading-[1.18] mb-4">
              {d.hero.titleLines.map((line, i) => (
                <span key={i} className="block">
                  {line.accent ? <span className="text-[#0D9488]">{line.text}</span> : line.text}
                </span>
              ))}
            </h1>
            <p
            ...
            <div className="imp-fade-up delay-2 flex flex-wrap gap-2.5 mb-8">
              {d.hero.perks.map((p, i) => (
                ...
                >
                  <DynIcon name="CheckCircle" className="text-[#0D9488] w-3.5 h-3.5" />
                  {p}
                </div>
              ))}
            </div>
            <div className="imp-fade-up delay-3 flex flex-wrap items-center gap-3.5 mb-8">
              <button
                type="button"
                onClick={() => onEnroll?.("daily")}
                className="inline-flex items-center gap-2 bg-[#0D9488] text-white font-['Poppins'] font-bold px-8 py-3.5 rounded-lg shadow-[0_4px_16px_rgba(13,148,136,0.35)] hover:bg-[#0F766E] transition-colors duration-200"
              >
              ...
              <a
                href="/brochures/MentorsDaily-UPSC-2030-Brochure.pdf"
                download="MentorsDaily-UPSC-2030-Brochure.pdf"
                className="inline-flex items-center gap-2 border-2 border-white/40 text-white font-['Poppins'] font-semibold px-7 py-3 rounded-lg hover:bg-white/10 transition-colors duration-200"
              >
          ...
          <div className="imp-fade-up delay-2 bg-white rounded-[20px] shadow-[0_24px_80px_rgba(0,0,0,0.28)] overflow-hidden" id="enroll">
            <div className="bg-gradient-to-br from-[#115E59] to-[#0F766E] px-6 py-6 text-center">
              <div className="w-16 h-16 rounded-[14px] bg-[#0D9488] mx-auto mb-3 flex items-center justify-center text-white text-3xl shadow-[0_8px_20px_rgba(13,148,136,0.4)]">
            ...
            <div className="p-6">
              <div className="flex items-end gap-2.5 mb-1">
                <div className="font-['Poppins'] text-4xl font-black text-[#115E59]">{heroPrice}</div>
              ...
              <button
                type="button"
                onClick={() => onEnroll?.("daily")}
                className="block w-full text-center bg-[#0D9488] text-white font-['Poppins'] font-bold py-4 rounded-[10px] shadow-[0_4px_14px_rgba(13,148,136,0.35)] hover:bg-[#0F766E] transition-colors duration-200"
              >
                {d.hero.enrollCta}
              </button>
              <button
                type="button"
                onClick={onEnquire}
                className="block w-full text-center border-2 border-[#5B8DB8] text-[#115E59] font-['Poppins'] font-semibold py-3 rounded-[10px] mt-2.5 hover:bg-[#D5E8F0] transition-colors duration-200"
              >
      ...
      {/* Trust bar */}
      <div className="bg-[#115E59] py-5">
        <div className="max-w-[1180px] mx-auto px-6 flex flex-wrap justify-around gap-5 items-center">
          {d.trustBar.map((t, i) => (
            <div key={i} className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-[10px] bg-white/10 flex items-center justify-center text-[#0D9488]">
      ...
      {/* Pricing */}
      <section className="bg-[#042F2E] py-20" id="pricing">
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-3">
            <span className="inline-block bg-[#CCFBF1] text-[#0D9488] text-xs font-bold uppercase tracking-wider px-3.5 py-1 rounded-full mb-3.5">
          ...
          <div className={`grid gap-7 mb-12 items-stretch ${showWeeklyPlan ? "md:grid-cols-2" : "grid-cols-1 max-w-[520px] mx-auto"}`}>
            {/* Daily first (left) */}
            <div className="rounded-[20px] overflow-hidden bg-white border-2 border-[#0D9488] shadow-[0_12px_48px_rgba(13,148,136,0.28)] relative hover:-translate-y-1 transition-transform flex flex-col">
              <div className="absolute top-[18px] -right-7 bg-[#0D9488] text-white text-[0.72rem] font-extrabold py-1.5 px-9 rotate-[38deg] z-[2] tracking-wide">
                {d.pricingSection.daily.popularRibbon}
              </div>
              <div className="px-8 pt-8 pb-5 border-b border-[#F2F4F7] bg-gradient-to-br from-[#115E59] to-[#0F766E]">
              ...
              <div className="px-8 py-6 flex flex-col grow">
                  ...
                  {d.pricingSection.daily.features.map((f, i) => (
                    <li key={i} className="flex gap-2.5 py-2 border-b border-[#F2F4F7] text-sm text-[#1C2B3A]">
                      <DynIcon
                        ...
                        size={16}
                      />
                      <span className={f.highlight ? "font-bold text-[#0D9488]" : ""}>{f.text}</span>
                    </li>
                  ))}
                </ul>
                <div className="mt-auto">
                  ...
                  <button
                    type="button"
                    onClick={() => onEnroll?.("daily")}
                    className="group block w-full text-center bg-[#0D9488] text-white font-['Poppins'] font-bold py-4 rounded-[10px] hover:bg-[#0F766E] shadow-[0_8px_20px_rgba(13,148,136,0.3)] transition-all"
                  >
            ...
            {showWeeklyPlan ? (
              <div className="rounded-[20px] overflow-hidden bg-white border-2 border-[#CBD5E1] hover:-translate-y-1 transition-transform shadow-[0_10px_30px_rgba(13,34,64,0.12)] relative flex flex-col">
                <div className="absolute top-5 right-5 text-[0.68rem] font-extrabold uppercase tracking-wide px-2.5 py-1 rounded-full bg-[#E8F1FF] text-[#115E59] border border-[#BFD7F1]">
                  Value Plan
                </div>
                <div className="px-8 pt-8 pb-5 border-b border-[#E5E7EB] bg-gradient-to-br from-[#F8FAFC] to-[#EEF4FB]">
                  <div className="font-['Poppins'] text-2xl font-extrabold text-[#115E59] mb-2">{d.pricingSection.weekly.name}</div>
                  <div className="flex items-end gap-2 flex-wrap">
                    <span className="font-['Poppins'] text-4xl font-black text-[#115E59]">{fmt(weeklyDisplayPrice)}</span>
                ...
                <div className="px-8 py-6 flex flex-col grow">
                  ...
                  <div className="mt-auto">
                    ...
                    <button
                      ...
                      className="group block w-full text-center bg-[#115E59] text-white font-['Poppins'] font-bold py-4 rounded-[10px] hover:bg-[#042F2E] shadow-[0_8px_20px_rgba(13,34,64,0.28)] transition-all"
                    >
          ...
          {!hideWeeklyPlan ? (
            ...
            <div className="overflow-x-auto">
              <table className="imp2030-comparison-table w-full table-fixed border-collapse text-sm">
                <thead>
                    ...
                    if (row.type === "text") {
                      return (
                        <tr key={ri} className="border-b border-white/6 hover:bg-white/4">
                          ...
                          <td className="align-middle px-3 text-center text-[0.85rem] font-semibold text-[#0D9488]">
                            {row.w}
                          </td>
                        </tr>
                      );
      ...
      <section className="bg-[#F8F9FB] py-20" id="program">
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="font-['Poppins'] font-extrabold text-[clamp(1.6rem,3vw,2.1rem)] text-[#115E59] whitespace-pre-line leading-tight">
              {d.uspSection.title}
            </h2>
              ...
              const shell =
                c.variant === "green"
                  ...
                  : c.variant === "blue"
                    ...
                    : "border-l-[#0D9488] bg-[#F0FDFA]";
              const iconShell =
                c.variant === "green"
                  ? "bg-[#D1FAE5] text-[#2D7D4E]"
                  : c.variant === "blue"
                    ? "bg-[#BFDBFE] text-[#115E59]"
          ...
          <div className="mt-8 bg-[#115E59] rounded-xl px-6 py-5 flex gap-3.5 items-start">
      ...
      <section className="bg-white">
        <div className="max-w-[1180px] mx-auto px-6 py-20">
          <div className="text-center mb-12">
            ...
            <h2 className="font-['Poppins'] font-extrabold text-[clamp(1.6rem,3vw,2.1rem)] text-[#115E59]">{d.featuresSection.title}</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {d.featuresSection.items.map((it, i) => {
              ...
              const iconBg = {
                navy: "bg-[#EEF3FA] text-[#115E59]",
                orange: "bg-[#CCFBF1] text-[#0D9488]",
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-[#115E59] mb-2 text-[1.05rem]">{it.title}</h3>
      ...
      <section className="bg-[#F8F9FB] py-20">
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-11">
            ...
            <h2 className="font-['Poppins'] font-extrabold text-[clamp(1.6rem,3vw,2.15rem)] text-[#115E59] leading-tight">
            ...
            <p className="text-[#6B7280] max-w-2xl mx-auto mt-3 leading-relaxed text-[0.95rem]">
              IMP 2030 students get exclusive access to a personalised digital dashboard that tracks every
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {dashboardCards.map((card, i) => (
              ...
              >
                ...
                <h3 className="font-['Poppins'] text-[0.96rem] font-bold text-[#115E59] mb-2">{card.title}</h3>
      ...
      <section className="bg-[#042F2E] py-20">
        <div className="max-w-[1240px] mx-auto px-6">
          <div className="text-center mb-10 md:mb-12">
            <span className="inline-block bg-[rgba(13,148,136,0.22)] text-[#0D9488] text-[0.68rem] sm:text-xs font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full mb-3.5 border border-[rgba(13,148,136,0.35)]">
          ...
          <div
            ...
            className="imp-timeline-scroll -mx-6 px-6 overflow-x-auto overflow-y-visible pb-2 scroll-smooth snap-x snap-mandatory lg:overflow-x-visible [scrollbar-width:thin] [scrollbar-color:rgba(13,148,136,0.6)_rgba(255,255,255,0.08)]"
          >
                  ...
                  >
                    <div
                      className={`w-14 h-14 rounded-full mx-auto mb-4 flex items-center justify-center text-white shadow-lg ${
                        ph.highlight
                          ? "ring-[3px] ring-[#0D9488]/55 shadow-[0_0_28px_rgba(13,148,136,0.42)]"
                          : ""
                      }`}
                    ...
                    {ph.dates && (
                      <div className="text-[0.62rem] sm:text-[0.65rem] font-bold uppercase tracking-wider text-[#0D9488] mb-1">
                        {ph.dates}
                      </div>
                    )}
          ...
          <div className="max-w-3xl mx-auto mt-4">
            <div className="h-1 rounded-full bg-white/12 mb-3 overflow-hidden">
              <div
                className="h-full bg-[#0D9488] rounded-full transition-[width] duration-150 ease-out"
                style={{ width: `${timelineViewPct}%` }}
              />
            </div>
            <div className="bg-[#115E59] border border-white/10 rounded-xl py-4 px-5 md:px-6 flex items-start gap-3 shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
              <DynIcon name="Info" className="text-[#0D9488] shrink-0 mt-0.5" size={20} />
      ...
      <section className="bg-[#F8F9FB] py-20">
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="font-['Poppins'] font-extrabold text-[clamp(1.6rem,3vw,2.1rem)] text-[#115E59]">{d.includedSection.title}</h2>
              ...
              <button
                ...
                className={`font-['Poppins'] text-sm font-semibold px-6 py-2.5 rounded-full border-2 transition ${
                  tab === t.id
                    ...
                    : "border-[#5B8DB8] text-[#115E59] hover:bg-[#115E59] hover:text-white"
                }`}
              >
                {t.label}
              </button>
          ...
          {included && (
            <div className="grid md:grid-cols-2 gap-5">
              {included.items.map((it, i) => (
                <div
                  key={i}
                  className="bg-white rounded-xl p-5 flex gap-3.5 shadow-sm border-l-4 border-[#115E59]"
                >
                  <div className="w-[42px] h-[42px] shrink-0 rounded-[10px] bg-[#D5E8F0] text-[#115E59] flex items-center justify-center">
                    <DynIcon name={it.icon} size={22} />
                  </div>
                  <div>
                    <h4 className="font-bold text-[#115E59] text-[0.95rem] mb-1">{it.title}</h4>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="font-['Poppins'] font-extrabold text-[clamp(1.6rem,3vw,2.1rem)] text-[#115E59]">{d.testimonialsSection.title}</h2>
          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-5">
            {d.testimonialsSection.items.map((t, i) => (
              <div
                key={i}
                className="bg-[#F8F9FB] rounded-2xl p-7 shadow-sm border-t-4 border-[#115E59] relative hover:-translate-y-1 hover:shadow-md transition-all duration-200"
              >
                <span className="absolute top-5 right-5 text-[0.72rem] font-bold px-2.5 py-1 rounded-full bg-[#CCFBF1] text-[#0D9488]">
                  {t.stage}
                </span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-[#115E59] text-sm">{t.name}</div>
                    <div className="text-xs text-[#6B7280] flex items-center gap-1">
                      <DynIcon name="MapPin" className="text-[#0D9488]" size={12} /> {t.loc}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-14 items-start">
            <div>
              ...
              <h2 className="font-['Poppins'] font-extrabold text-[clamp(1.6rem,3vw,2.1rem)] text-[#115E59] mb-3">{d.faqSection.title}</h2>
              <p className="text-[#6B7280] mb-7">{d.faqSection.sub}</p>
              <div className="bg-[#115E59] rounded-xl p-7">
                <p className="text-[#D5E8F0] text-sm mb-3.5">Still have questions? Talk to our team directly.</p>
                <a
                  href={`https://wa.me/${d.contact.wa}?text=${encodeURIComponent("Hello MentorsDaily! I have a query about IMP 2030.")}`}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 bg-[#0D9488] text-white text-sm font-bold px-5 py-3 rounded-lg"
                >
            ...
            <ul className="list-none m-0 p-0 space-y-3">
              {d.faqSection.items.map((item, i) => (
                ...
                >
                  <button
                    type="button"
                    className="w-full flex items-center justify-between gap-3 py-4 text-left font-['Poppins'] font-semibold text-[#115E59] hover:text-[#0D9488] bg-transparent border-0 cursor-pointer"
                    onClick={() => setOpenFaq(openFaq === i ? -1 : i)}
                  >
                    {item.q}
                    <span
                      className={`w-7 h-7 rounded-full flex items-center justify-center text-xs shrink-0 transition ${
                        openFaq === i ? "bg-[#0D9488] text-white rotate-45" : "bg-[#D5E8F0] text-[#0F766E]"
                      }`}
                    >
                      +
                    </span>
      ...
      {/* Bottom CTA */}
      <section className="bg-gradient-to-br from-[#042F2E] to-[#115E59] py-20 text-center">
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              type="button"
              onClick={() => onEnroll?.("daily")}
              className="inline-flex items-center gap-2 bg-[#0D9488] text-white font-bold px-9 py-4 rounded-lg text-lg hover:bg-[#0F766E]"
            >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur border-t border-[#E5E7EB] p-3 z-[998] shadow-[0_-4px_20px_rgba(0,0,0,0.12)]">
        <button
          type="button"
          onClick={() => onEnroll?.("daily")}
          className="w-full flex items-center justify-center gap-2 bg-[#0D9488] text-white font-bold py-3 rounded-lg transition-colors duration-200 hover:bg-[#0F766E]"
        >
