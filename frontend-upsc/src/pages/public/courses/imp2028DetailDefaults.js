  ...
  return {
    ...
    timelineSection: {
      ...
      phases: [
        ...
        { numLabel: "3", color: "#5B8DB8", sub: "Oct – Dec 2026", label: "GS Paper I Deep Dive" },
        { numLabel: "4", color: "#5B8DB8", sub: "Jan – Mar 2027", label: "GS Paper II & III" },
        { numLabel: "5", color: "#24527A", sub: "Apr – Jun 2027", label: "GS Paper IV + Optional" },
        { numLabel: "6", color: "#24527A", sub: "Jul – Sep 2027", label: "Integrated Revision I" },
        { numLabel: "7", color: "#5B8DB8", sub: "Oct – Dec 2027", label: "Full Mock Test Series" },
        { numLabel: "8", color: "#E86B2A", sub: "Jan – May 2028", label: "Prelims Final Sprint" },
        { numLabel: "9", color: "#2D7D4E", sub: "Jun – Sep 2028", label: "Mains Answer Writing" },
        { numLabel: "🏆", color: "#7C3AED", sub: "Oct 2028 – Apr 2029", label: "Mains Exam + Interview" },
      ],
