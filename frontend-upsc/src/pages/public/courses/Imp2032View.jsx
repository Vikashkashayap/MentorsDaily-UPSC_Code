...
export default function Imp2032View({
  d,
  sellingPrice,
  basePrice,
  discountPercentage,
  ...
  return (
    <div className="imp2032-root bg-white overflow-x-hidden pb-24 md:pb-0">
      {/* Announcement */}
      ...
      {/* Hero */}
      <section
        className="relative bg-gradient-to-br from-[#0D2240] via-[#1A3C6E] to-[#1e4d82] pt-16 pb-14 overflow-hidden"
        id="top"
      >
      ...
      <section className="bg-[#0D2240] py-20" id="pricing">
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <div className="max-w-[720px] mx-auto">
            <div className="rounded-[20px] overflow-hidden bg-white border-2 border-[#E86B2A] shadow-[0_12px_48px_rgba(232,107,42,0.28)] relative flex flex-col">
                    ...
                    <li key={i} className="flex gap-2.5 py-2 border-b border-[#F2F4F7] text-sm text-[#1C2B3A]">
                      <DynIcon
                        ...
                        className={`shrink-0 mt-0.5 ${
                          f.cls === "green" ? "text-[#2D7D4E]" : f.cls === "orange" ? "text-[#E86B2A]" : "text-[#F59E0B]"
                        }`}
                        size={16}
                      />
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-7">
            {d.uspSection.cards.map((c, i) => {
              ...
              const titleCls =
                c.variant === "green" ? "text-[#2D7D4E]" : c.variant === "blue" ? "text-[#1A3C6E]" : "text-[#E86B2A]";
              const chip =
                c.variant === "green"
                  ? "bg-[#D1FAE5] text-[#2D7D4E]"
                  : c.variant === "blue"
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-11">
            ...
            <p className="text-[#6B7280] max-w-2xl mx-auto mt-3 leading-relaxed text-[0.95rem]">
              IMP 2032 students get access to a personalised digital dashboard that tracks every dimension of UPSC preparation in real time.
            </p>
          </div>
        ...
        <div className="max-w-[1240px] mx-auto px-6">
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-full mx-auto mb-4 flex items-center justify-center text-white shadow-lg ${
                      ph.highlight ? "ring-[3px] ring-[#E86B2A]/55 shadow-[0_0_28px_rgba(232,107,42,0.42)]" : ""
                    }`}
          ...
          <div className="max-w-3xl mx-auto mt-4">
            <div className="h-1 rounded-full bg-white/12 mb-3 overflow-hidden">
              <div className="h-full bg-[#E86B2A] rounded-full transition-[width] duration-150 ease-out" style={{ width: `${timelineViewPct}%` }} />
            </div>
            ...
            {d.includedSection.tabs.map((t) => (
              <button
                ...
                className={`font-['Poppins'] text-sm font-semibold px-6 py-2.5 rounded-full border-2 transition ${
                  tab === t.id ? "bg-[#1A3C6E] text-white border-[#1A3C6E]" : "border-[#5B8DB8] text-[#1A3C6E] hover:bg-[#1A3C6E] hover:text-white"
                }`}
              >
                {t.label}
              </button>
          ...
          {included ? (
            <div className="grid md:grid-cols-2 gap-5">
              {included.items.map((it, i) => (
                <div key={i} className="bg-white rounded-xl p-5 flex gap-3.5 shadow-sm border-l-4 border-[#1A3C6E]">
          ...
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-14 items-start">
            <div>
              ...
              <div className="bg-[#1A3C6E] rounded-xl p-7">
                ...
                <a
                  href={`https://wa.me/${d.contact.wa}?text=${encodeURIComponent("Hello MentorsDaily! I have a query about IMP 2032.")}`}
                  target="_blank"
                  rel="noreferrer"
