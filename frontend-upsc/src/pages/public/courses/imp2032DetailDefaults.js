/**
 * Default long-form landing copy for Integrated Mentorship 2032.
 * Admin overrides merge shallow-deep via course.detailPage (Mongo Mixed).
 */

export const IMP_2032_SLUG = "integrated-mentorship-2032";
...
export function getDefaultImp2032DetailPage() {
  return {
    seo: {
      title: "IMP 2032 – Integrated UPSC Mentorship Program | MentorsDaily",
      description:
        "Join MentorsDaily IMP 2032 — a long-term, fully integrated UPSC mentorship journey with 1:1 mentoring, structured targets, practice, tests, and complete support across Prelims, Mains & Interview. Daily mentorship plan fee: ₹2,10,000.",
    },
    announcement: {
      strong: "Admissions Open:",
      text: "IMP 2032 Daily Mentorship intake is now open — limited seats.",
    ...
    hero: {
      ...
      cardTitle: "Integrated Mentorship Program (IMP) 2032",
    ...
    pricingSection: {
      ...
      title: "One Plan.\nComplete Support.",
      sub: "Daily 1:1 mentorship, structured targets, evaluations, tests and full program support. (Weekly plan is not available for IMP 2032.)",
      daily: {
        name: "Daily Mentorship",
        popularRibbon: "Daily Only",
        price: 210000,
        oldPrice: 420000,
        saveLabel: "Save ₹2,10,000 (50% OFF)",
        durationLine: "IMP 2032 · Daily 1:1 mentorship",
        features: [
          { ok: true, cls: "green", text: "Daily 1:1 mentorship sessions (personalized)" },
          { ok: true, cls: "green", text: "Dedicated personal mentor for guidance & support" },
          { ok: true, cls: "green", text: "Observation period to assess your preparation level and plan" },
          { ok: true, cls: "green", text: "Structured roadmap: Structure + Syllabus + PYQ" },
          { ok: true, cls: "green", text: "Free study materials: notes, resources & curated content" },
          { ok: true, cls: "green", text: "Personal plan (study plan) as per your goals & timetable" },
          { ok: true, cls: "green", text: "Value-added notes for better understanding & quick revision" },
          { ok: true, cls: "green", text: "Regular modular tests to assess your preparation" },
          { ok: true, cls: "green", text: "Full-length tests (module-wise + subject-wise)" },
          { ok: true, cls: "green", text: "Fault analysis sessions to identify mistakes & improve accuracy" },
          { ok: true, cls: "green", text: "Answer writing practice + evaluation (daily)" },
          { ok: true, cls: "green", text: "DART (Daily Activity Reflection Tracker) to stay accountable" },
          { ok: true, cls: "green", text: "Modular Mains tests (subject/topic-wise)" },
          { ok: true, cls: "gold", text: "Mentorship analysis + performance reports", highlight: true },
          { ok: true, cls: "green", text: "Strategic sessions for exam strategy & improvement" },
          { ok: true, cls: "green", text: "Prelims focus batch: revision + syllabus + notes" },
          { ok: true, cls: "green", text: "Prelims test series: group sessions for practice" },
          { ok: true, cls: "green", text: "Mains focus batch: targets + tests + revision + AW training" },
          { ok: true, cls: "green", text: "Mains test series: comprehensive series for Mains" },
          { ok: true, cls: "green", text: "Hostel + food + library + stationery support (during key phases)" },
          { ok: true, cls: "orange", text: "Mock interviews with expert panel to build confidence", highlight: true },
        ],
    ...
    timelineSection: {
      ...
      note: "IMP 2032 is a Daily-only mentorship plan. Your mentor aligns targets, reviews and strategy consistently through all stages.",
    },
    includedSection: {
      tag: "FULL CURRICULUM",
    ...
    faqSection: {
      ...
      items: [
        { q: "Is there a weekly plan for IMP 2032?", a: "No. IMP 2032 is Daily mentorship only." },
        { q: "What is the fee for IMP 2032?", a: "IMP 2032 Daily plan fee is ₹2,10,000." },
        { q: "How do I enroll?", a: 'Click "Enroll Now" on this page or talk to our team on WhatsApp / call.' },
      ],
    },
    bottomCta: {
      title: "Start Your IMP 2032 Journey",
      sub: "Daily mentorship + structured targets + complete support — built for serious aspirants.",
      primary: "Enroll in IMP 2032",
