  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12 animate-fadeIn">
      <div className="flex justify-center w-full">
        ...
        alt="UPSC Prelims Preparation Features - Comprehensive Prelims Study Plan, Mock Tests, Current Affairs Coverage for Civil Services Exam 2030"
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12 animate-fadeIn">
      <div className="flex justify-center w-full">
        <img
          ...
          alt="UPSC Mains Preparation Features - Answer Writing Practice, Essay Writing, Optional Subject Guidance, GS Paper Coverage for Civil Services Mains Exam 2030"
          className="w-full h-auto max-w-none md:max-w-5xl rounded-none sm:rounded-xl shadow-none sm:shadow-lg sm:hover:scale-105 transition-transform duration-300"
          loading="lazy"
          decoding="async"
        />
...
const keyFeatures = [
  ...
  },
  {
    ...
    description: "Weekly study plans tailored to UPSC CSE 2030 syllabus with structured timeline.",
...
const testimonials = [
  {
    name: "Ishita Verma",
    location: "Ranchi",
    text: "IMP 2030 is for visionaries who plan ahead. With 4+ years to prepare, I'm building expertise that goes beyond the exam. My mentor helps me develop analytical thinking and leadership qualities alongside subject knowledge. This program is about becoming a well-rounded civil servant.",
    rating: 5
  },
  {
    name: "Kunal Deshmukh",
    location: "Nashik",
    text: "UPSC 2030 seems far away, but IMP 2030 makes it feel achievable. The program's long-term approach includes personality development, emotional intelligence, and ethical decision-making. My mentor is like a life coach who happens to be an exam expert too.",
    rating: 5
  },
  {
    name: "Ananya Bhattacharya",
    location: "Raipur",
    text: "IMP 2030 gives me the luxury of time to explore diverse subjects and develop original thinking. My mentor encourages research, debate, and critical analysis. This isn't just exam preparation - it's intellectual growth that will serve me throughout my career in civil services.",
    rating: 5
  }
];
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        ...
        // Find course matching "Integrated" and "2030"
        const foundCourse = coursesData.find(c => {
          const title = (c.title || '').toLowerCase();
          return title.includes('integrated') && title.includes('2030');
        });
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 font-medium">
              66 Months | Complete UPSC CSE 2030 Preparation
            </p>
          ...
          <div className="mt-8 max-w-4xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-blue-100 shadow-lg">
              ...
              <div className="space-y-3 text-gray-600 leading-relaxed text-sm md:text-base">
                <p>
                  Thinking about UPSC 2030 already? That shows you're serious about this. And honestly, that's the kind of mindset that gets results. With 66 months to prepare, you're setting yourself up for the most comprehensive preparation possible.
                </p>
                <p>
                  Here's the reality: UPSC preparation is a marathon, not a sprint. The candidates who crack it aren't the ones who study 18 hours a day for 6 months. They're the ones who study consistently, get proper guidance, and build their knowledge brick by brick over time. That's what this program is designed for - steady, consistent progress over the long term.
                </p>
                <p>
                  Your mentor will be your constant companion through this entire journey. They'll help you build a strong foundation, develop deep subject knowledge, master answer writing, and prepare for the interview. But more importantly, they'll help you stay motivated, manage stress, and maintain balance in your life. Because let's face it - you can't give your best if you're burned out.
                </p>
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="mb-5">
                    <img
                      src={feature.image}
                      alt={`${feature.title} - ${feature.description} for UPSC 2030 Preparation`}
            ...
            <div className="group bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-blue-200 hover:border-blue-400">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">66 Months Comprehensive Program</h3>
