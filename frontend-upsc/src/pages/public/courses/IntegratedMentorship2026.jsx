...
const keyFeatures = [
  ...
  },
  {
    ...
    description: "Weekly study plans tailored to UPSC CSE 2026 syllabus with structured timeline.",
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        ...
        // Find course matching "Integrated" and "2026"
        const foundCourse = coursesData.find(c => {
          const title = (c.title || '').toLowerCase();
          return title.includes('integrated') && title.includes('2026');
        });
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 font-medium">
              18 Months | Complete UPSC CSE 2026 Preparation
            </p>
          ...
          <div className="mt-8 max-w-4xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-blue-100 shadow-lg">
              ...
              <div className="space-y-3 text-gray-600 leading-relaxed text-sm md:text-base">
                <p>
                  You know what? Most coaching centers treat students like numbers. They give you the same study plan, the same schedule, and expect everyone to perform the same way. But here's the thing - that doesn't work. Not for UPSC, and definitely not for you.
                </p>
                <p>
                  When we started MentorsDaily, we were frustrated too. We saw students struggling, feeling lost, and giving up because they didn't get the right guidance. So we decided to do things differently. Instead of one-size-fits-all, we built something personal. Something that actually listens to you, understands where you're coming from, and helps you move forward at your own pace.
                </p>
                <p>
                  The Integrated Mentorship Program isn't about following a template. It's about having a real person - your mentor - who knows your story, your strengths, your weak points, and your goals. They're not just teaching you; they're walking this journey with you. When you're stuck, they help you out. When you're demotivated, they lift you up. When you need clarity, they give it to you straight.
                </p>
                <p className="font-semibold text-gray-900 text-base md:text-lg">
                  Think of it this way:{" "}
                  <em className="text-blue-600">
                    You're not alone in this. You have someone who genuinely cares about your success and is committed to making it happen.
                  </em>
                </p>
              </div>
            </div>
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="mb-5">
                    <img
                      src={feature.image}
                      alt={`${feature.title} - ${feature.description} for UPSC 2026 Preparation`}
            ...
            <div className="group bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-blue-200 hover:border-blue-400">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">18 Months Comprehensive Program</h3>
