...
const CANONICAL = "https://mentorsdaily.com/upsc-age-calculator";
const OG_IMAGE = `${SEO_CONFIG.siteUrl}/images/hero.webp`;
...
function buildStructuredData() {
  ...
  const webPageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "UPSC Age Calculator 2026 - Check IAS Eligibility & Attempts",
    description:
      "Use MentorsDaily UPSC Age Calculator to instantly check IAS eligibility, UPSC age limit, category relaxation, and remaining attempts for UPSC CSE 2026.",
    url: CANONICAL,
    isPartOf: {
      "@type": "WebSite",
      name: "MentorsDaily",
    ...
    about: {
      "@type": "Thing",
      name: "UPSC Civil Services Examination Age Eligibility",
    },
  };
  ...
  const softwareSchema = {
    ...
    name: "MentorsDaily UPSC Age Calculator",
  ...
  return [webPageSchema, faqSchema, breadcrumbSchema, softwareSchema];
}
...
function UPSCAgeCalculatorPage() {
  ...
  return (
    <>
      <Helmet>
        <title>UPSC Age Calculator 2026 - Check IAS Eligibility &amp; Attempts</title>
        <meta
          name="description"
          content="Use MentorsDaily UPSC Age Calculator to instantly check IAS eligibility, UPSC age limit, category relaxation, and remaining attempts for UPSC CSE 2026."
        />
        <meta
          name="keywords"
          content="UPSC Age Calculator, IAS Age Calculator, UPSC Eligibility Calculator, UPSC Age Limit Calculator, UPSC Attempt Calculator, IAS Eligibility Checker, UPSC Eligibility by DOB, UPSC Age Criteria, UPSC Age Limit for OBC, UPSC Age Limit for SC ST, UPSC Age Limit for General"
        />
        <link rel="canonical" href={CANONICAL} />
        <meta property="og:title" content="UPSC Age Calculator 2026 - Check IAS Eligibility & Attempts" />
        <meta
        ...
        <meta name="twitter:title" content="UPSC Age Calculator 2026 - Check IAS Eligibility & Attempts" />
        <meta
